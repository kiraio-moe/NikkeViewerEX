...
Shader "Spine 4.0/Outline/Skeleton Lit ZWrite" {
	Properties {
	...
	SubShader {
		...
		UsePass "Spine 4.0/Skeleton Lit ZWrite/NORMAL"

		UsePass "Spine 4.0/Skeleton Lit ZWrite/CASTER"
	}
	FallBack "Spine 4.0/Skeleton Lit ZWrite"
