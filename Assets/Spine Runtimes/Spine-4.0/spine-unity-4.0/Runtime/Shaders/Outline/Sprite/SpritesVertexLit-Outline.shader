...
Shader "Spine 4.0/Outline/Sprite/Vertex Lit"
{
	Properties
	{
	...
	SubShader
	{
		...
		UsePass "Spine 4.0/Sprite/Vertex Lit/VERTEX"

		UsePass "Spine 4.0/Sprite/Vertex Lit/SHADOWCASTER"
	}

	FallBack "Spine 4.0/Sprite/Vertex Lit"
