...
Shader "Spine 4.1/Outline/Sprite/Vertex Lit"
{
	Properties
	{
	...
	SubShader
	{
		...
		UsePass "Spine 4.1/Sprite/Vertex Lit/VERTEX"

		UsePass "Spine 4.1/Sprite/Vertex Lit/SHADOWCASTER"
	}

	FallBack "Spine 4.1/Sprite/Vertex Lit"
